...
var range = document.querySelector('.range-amount');

if (amount && range) {
  var updateInput = function updateInput(val, el) {
    el.value = val;
  };
...
module.exports = __webpack_require__(/*! /home/oleh/Project/gdr/resources/js/main.js */"./resources/js/main.js");
