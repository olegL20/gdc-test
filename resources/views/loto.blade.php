...
<div class="roulette-page">
    ...
    <p class="roulette-description">Наша рулетка работает по защищенной системе <strong>"Randomizer"</strong> <br> О ней вы можете узнать <a href="https://www.randomizer.org/" class="system-info">тут</a></p>
