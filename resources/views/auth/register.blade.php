                    ...
                    <div class="card-body">
                        @if (request()->getHost() === 'gdc-invest.net')
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <input type="hidden"
                                    name="refUser"
                                    value="{{isset($_GET['refUser']) ? $_GET['refUser'] : 0}}">
                                ...
                                <div class="form-group row">
                                    <label for="surname"
                                        class="col-md-4 col-form-label text-md-right">{{ __('auth.surname') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="country"
                                        class="col-md-4 col-form-label text-md-right">{{ __('auth.country') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="region"
                                        class="col-md-4 col-form-label text-md-right">{{ __('auth.region') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="confirm_18"
                                        class="col-md-4 col-form-label text-md-right">{{ __('auth.18') }}</label>

                                    <div class="col-md-6">
                                        <input id="confirm_18"
                                            type="checkbox"
                                            class="{{ $errors->has('confirm_18') ? ' is-invalid' : '' }}"
                                            name="confirm_18"
                                            required>
                        ...
                        @else
                            <p style="font-size: 2em">{{__('page.register')}}</>
